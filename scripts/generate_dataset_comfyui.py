...
THEME_DESCRIPTIONS = {
    ...
    "spectral": "Wide visual variety for semantic audio training — dark/bright, smooth/chaotic, warm/cool",
}
...
# --- Spectral: wide visual variety for semantic audio-visual training ---
THEME_TEMPLATES["spectral"] = r"""{deep void of {black|dark blue|dark purple|charcoal} nothingness, heavy shadows, dark nebula clouds, thick black smoke billowing, oppressive darkness, barely visible forms|dense {obsidian|onyx|coal|slate|iron|graphite} mass, heavy blocky shapes, dark monolithic forms, crushing weight, minimal light, deep shadows|crystalline {frost|ice|diamond|quartz|glass|prismatic} patterns on {black|dark|white|grey} background, razor-sharp edges, intricate geometric filigree, bright white light refractions, fine detail|delicate {snowflake|lace|spider web|circuit trace|capillary|neural} structure, extremely fine lines, high-frequency detail, {white|silver|crystal|bright cyan|pale gold} on {black|dark blue|dark grey} background|soft {pastel gradient|foggy landscape|misty morning|out-of-focus bokeh|blurred watercolor|diffused light}, smooth transitions, no sharp edges, {pink-lavender|blue-grey|peach-cream|mint-white|amber-gold|rose-silver} gentle tones|smooth {cloudscape|silk fabric|calm water surface|sand dunes|marble veins|smoke wisps}, flowing organic forms, minimal texture, {cream|pale blue|soft pink|light grey|warm beige|pearl} muted palette|{TV static|digital noise|random pixel|analog snow|grain texture|dithered random} pattern filling frame, {monochrome|RGB|multicolor|grey|blue|green} noisy chaos, no structure, uniform randomness|corrupted {data|image|signal|transmission|file|scan} visualization, {pixelated|blocky|banded|striped|checkered|scattered} artifacts, chaotic {multi-color|neon|monochrome|pastel|glitch|acid} noise pattern|stark {black and white|high contrast monochrome|dramatic chiaroscuro|silhouette|shadow and light|ink on white} composition, {geometric|organic|architectural|natural|abstract|figurative} bold shapes, extreme contrast, no midtones|sharp {silhouette|cutout|stencil|shadow|negative space|figure-ground} forms, pure {black on white|white on black|dark on light|light on dark} with no gradation, dramatic graphic impact|{fire|lava flow|molten metal|sunset amber|golden hour light|red ember} warm scene, {orange|crimson|gold|amber|scarlet|vermillion} dominant palette, radiating {heat|warmth|energy|intensity|passion|glow}, hot tones throughout|{candle light|autumn leaves|desert sand|copper patina|honey|warm wood} toned scene, {golden|amber|russet|sienna|burnt orange|warm brown} color harmony, inviting warm atmosphere|{glacier|deep ocean|arctic|moonlit frost|blue steel|frozen lake} cool scene, {cyan|cobalt|teal|ice blue|navy|silver-blue} dominant palette, cold {stillness|depth|clarity|crispness|serenity|distance}|{winter night|frozen waterfall|crystalline cave|polar ice|blue hour|underwater deep} scene, {pale blue|steel grey|silver|frost white|deep navy|teal} cool monochrome, chilling atmosphere|medium detail {textile|woven|knit|canvas|paper|ceramic} texture, balanced composition of {geometric|organic|repeating|mixed|layered|tiled} elements, moderate visual complexity, {neutral|earth|muted|balanced|mid-tone|warm-cool} palette|{patchwork|mosaic|collage|mixed media|assemblage|composite} of {varied|mixed|diverse|contrasting|complementary|balanced} elements, medium spatial frequency, moderate detail density, {colorful|earth tone|jewel tone|neutral|warm|cool} mix|dense {wire mesh|circuit board traces|fractal branching|crosshatch|maze|neural network} pattern, {metallic|neon|white|gold|copper|silver} fine lines on {black|dark|grey|deep blue|dark green|charcoal}, extremely high edge density, intricate paths|{root system|river delta|lightning tree|vascular network|coral branches|mycelium web} branching pattern, {white|gold|green|blue|red|silver} dense interconnections on {black|dark|earth|deep} background, maximum edge complexity|bright overexposed {white|cream|pale|washed out|high-key|bleached} scene mixed with deep {black|shadow|dark|void|charcoal|cave} areas, extreme brightness range, {high dynamic range|HDR|split lighting|mixed exposure|contrasty|complex tonality}|{stained glass|kaleidoscope|prismatic|spectral dispersion|rainbow|color wheel} multicolor composition, areas of {brilliant light|deep shadow|bright highlight|dark depth|glowing|absorbing}, wide tonal and chromatic range}, {high contrast, sharp focus|dark background, vivid color|detailed texture, crisp|atmospheric, moody|clean, minimal|bold, saturated|soft, dreamy|noisy, chaotic|stark, graphic}"""
